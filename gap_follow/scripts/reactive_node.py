...
class ReactiveFollowGap(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('forsee_distance', 3.0)   # ranges beyond this threshold are clipped
        ...
        self.declare_parameter('following_orientation', 1/2 + 1/9)   # 1/2 means the center, small means right, bigger means left

        self.declare_parameter('kp', 0.4)
        self.declare_parameter('ki', 0.0)
        self.declare_parameter('kd', 0.1)
        self.declare_parameter("max_control", 0.36)   # rad
