...
class DynamicPlanner(Node):
    ...
    def __init__(self):
        ...
        csv_loc = '/home/lucien/ESE6150/traj_map_low.csv'
        ...
        # Topics & Subs, Pubs
        pose_topic = "/pf/viz/inferred_pose" if self.real_test else "/opp_racecar/odom"
        scan_topic = "/opp_scan"
        drive_topic = '/opp_drive'
        
        grid_topic = '/grid_2'
        rrt_topic = '/rrt_2'
        smooth_topic = '/smooth_2'
        waypoint_topic = '/waypoint_2'
        path_topic = '/global_path_2'
        fps_topic = '/fps_2'
